...
|Don’t assume prior knowledge and define all required formulas and logic explicitly| Use: *Calculate the margin as (Total Gross Profit / Total Revenue) × 100*.<br><br> Avoid: *Use the standard margin calculation*. |
...
![Applying a filter through an expression](images/semantic_model_edit_filter.png){: caption="A filter displays in the Expression editor." caption-side="bottom"}
