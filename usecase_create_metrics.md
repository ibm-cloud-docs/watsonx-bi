...
6. Metadata enrichment runs automatically.
...
7. If you are using watsonx.data intelligence for enrichment, you can review the enriched data and make necessary changes to labels and descriptions, or accept the suggested ones. 
...
9. You are now on the **Metrics overview** page and can create metrics by:
   ...
   - [Generating them automatically](/docs/watsonx-bi?topic=watsonx-bi-generate_metrics){: external} 
      ...
      The generation experience differs depending on your environment:
      ...
      In both cases, watsonx BI creates the metric definitions, enriches the newly-generated metric definitions,   and exports the selected metric definitions to the project as metrics for use in conversations.
