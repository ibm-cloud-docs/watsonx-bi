...
3. Confirm the deletion when prompted. You might be required to enter the project name to confirm. 

To delete a project from within the project: 

1. Open the project from **Navigation Menu > Projects > View all projects**. 

2. Go to the **Manage** tab.

3. Click **Delete project** in the **Danger zone** section. 
...
3. Click **Leave project** in the **Danger zone** section. 

4. Confirm that you want to leave the project when prompted. 
