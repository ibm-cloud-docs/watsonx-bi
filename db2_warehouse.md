...
First add the user ID as an IAM user or as a service ID. For instructions, see the Console user experience section of the [Identity and access management (IAM) on IBM Cloud](/docs/db2wh-saas?topic=db2wh-saas-iam#console-ux){: external} topic.
