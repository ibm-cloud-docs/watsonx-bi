...
The chat canvas is an active conversation and any question that you enter in the input box continues the conversation. To start a new conversation about a different data topic, click **New conversation**.

You can even set the scope of a conversation by selecting the data that you want to ask about from the list in the input box. By default, the scope of a conversation is set to **All data**. 

All conversations are saved in the **Conversations** panel, which is titled by default with your first question. You can expand or collapse this panel at any time.
...
You can access suggested questions in the expanded view of a metric in the **Key metrics** panel. These suggested questions can be used to get more insight into the metric data of the selected visualization.
...
AI-generated responses may not always be correct. Make sure that you verify generated responses and suggestions. 
{: important}
...
:   Select a metric to review related insights. Insights are shown only if there is a change in the data. 
...
:   Enter your question about a metric or other business data in the input box. If you're unsure of what to ask, select a suggested question. 
