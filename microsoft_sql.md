...
Microsoft SQL Server is a relational database management system. {: #shortdesc}
...
- Database name - You do not have to specify the database. With no database specified, you can import metadata from every database that is available for that connection.
